...
export default function PageNotFound() {
  return (
    <section className="h-[80vh] flex flex-col gap-3 justify-center">
      ...
      <p className="text-gray-800 text-center px-2 md:px-28 dark:text-gray-100">
        Looks like you&apos;ve found the doorway to the{" "}
        <strong>great nothing.</strong> You didn&apos;t break the internet, but
        I can&apos;t find what you are looking for. Please visit my{" "}
